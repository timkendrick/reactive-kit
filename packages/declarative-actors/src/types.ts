...
export const VALUE_RESOLVER_TYPE = Symbol.for(
  '@reactive-kit/declarative-actors/value-resolver-type',
);
...
export const STATE_HANDLE_VALUE_RESOLVER_TYPE = Symbol.for(
  '@reactive-kit/declarative-actors/value-resolver/state-handle',
);
...
export const READ_STATE_VALUE_RESOLVER_TYPE = Symbol.for(
  '@reactive-kit/declarative-actors/value-resolver/read-state',
);
...
export const COMPUTE_STATE_VALUE_RESOLVER_TYPE = Symbol.for(
  '@reactive-kit/declarative-actors/value-resolver/compute-state',
);
...
export const SPAWNED_ACTOR_VALUE_RESOLVER_TYPE = Symbol.for(
  '@reactive-kit/declarative-actors/value-resolver/spawned-actor',
);
